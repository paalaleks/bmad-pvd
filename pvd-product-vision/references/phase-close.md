...
5. If team customizes were wiped, re-run `pvd-product-vision setup` — or rely on activation to re-copy missing team customizes (`bmad-prd`, `bmad-code-review`, `bmad-ux`, create-epics/story).
